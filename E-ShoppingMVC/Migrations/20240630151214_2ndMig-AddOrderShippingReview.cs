...
{
    /// <inheritdoc />
    public partial class _2ndMigAddOrderShippingReview : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_ShipAddresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserReviews_AspNetUsers_UserModelId",
                        column: x => x.UserModelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserReviews_OrderDetails_OrderDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_OrderDetailId",
                table: "UserReviews",
                column: "OrderDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_UserReviews_UserModelId",
                table: "UserReviews",
                column: "UserModelId");
        }
